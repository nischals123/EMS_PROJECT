				...
				<form action="${pageContext.request.contextPath}/employees"
					...
					<div class="form-row">
						<div class="left-form-section">
							...
							<!-- Before -->
							<!-- <div class="form-group">
								<label for="picturePath">Picture L:</label> <input type="text"
									id="picturePath" name="picturePath"
									value="${fn:escapeXml(employee.picturePath)}" />
							</div> -->
							<!-- After -->
						<div class="form-group file-upload">
                        <label for="picturePath"><i class="fas fa-image"></i> Profile Picture</label>
                        <input type="file" id="photo" name="photo" accept="image/*" value="${fn:escapeXml(employee.picturePath)}" required>
