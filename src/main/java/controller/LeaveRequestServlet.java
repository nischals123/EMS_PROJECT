...
public class LeaveRequestServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<LeaveRequest> leaveRequests = LeaveRequestDAO.getUserLeaveRequests(user.getId());
    ...
    private void loadLeaveRequestsAndForward(HttpServletRequest request, HttpServletResponse response, int userId)
        ...
        List<LeaveRequest> leaveRequests = LeaveRequestDAO.getUserLeaveRequests(userId);
        request.setAttribute("leaveRequests", leaveRequests);
