...
<%
    ...
    if (user != null) {
        response.sendRedirect("${pageContext.request.contextPath}/view/user/dashboard.jsp");
        return;
    }
%>
<!DOCTYPE html>
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-buttons">
                    <a href="${pageContext.request.contextPath}/view/user/register.jsp" class="btn btn-primary">Get Started <i class="fas fa-arrow-right"></i></a>
        ...
        <div class="container">
            ...
            <div class="about-content">
                <div class="about-text">
                    ...
                    <div class="about-cta">
                        <a href="${pageContext.request.contextPath}/view/r egister.jsp" class="btn btn-primary">Join Us Today</a>
                    </div>
                </div>
